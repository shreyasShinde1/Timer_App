...
const activeTimers = document.getElementById('current-timer');
// Display the initial "You have no timers currently!" text
displayNoTimersText();

// Get a reference to the 'startTimer' button in the HTML
const startTimerButton = document.getElementById('set-time');
...
function playAudioAlert() {
    const audio = new Audio('./timerEndRing/hotel-bell-ding-1-174457.mp3'); // Replace with the path to your audio file
    audio.play();
}